import {projects} from "../constants/ProjectsConst.js";
...
const Projects = () => {
    ...
    return (
        <section className="c-space my-20">
            <h2 id="projects" className="text-neutral-400 text-3xl font-bold mb-10 ml-3">My Projects</h2>

            <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full text-amber-50">
